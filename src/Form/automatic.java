...
public class automatic extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_jenismobil.setText("AUTOMATIC");
    ...
    private void jButton_deteksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_deteksiActionPerformed
        ...
        if(jmlbaris == 0){
            ...
            jLabel_kesimpulan.setText(String.valueOf("ENGINE MOUNTING MOBIL MATIC ANDA MENGALAMI KERUSAKAN SEBESAR "+(persen)+"%"));      
            if(persen >= 50){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(automatic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
